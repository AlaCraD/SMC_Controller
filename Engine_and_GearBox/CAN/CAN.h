...
#define CAN_H_
	...
	*/
	...
	/* CANINTE */ // –азрешение на конкретные прерывани€ 
	...
	/* CANINTF */ //‘лаги состо€ний конкретных прерываний
	...
	#define MCP_CS_OFF	SET_1(P_CS)
	#define MCP_CS_ON	SET_0(P_CS)
	...
	uint8_t mcp_send_message(CANMessage*);
	uint8_t mcp_get_message(CANMessage *);
